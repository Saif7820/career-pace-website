...
const Hero6 = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div
          className="flex items-center gap-4 text-white px-6 py-4 rounded-2xl shadow-xl w-[80vw] min-w-[260px] max-w-[300px] md:w-full md:min-w-0 shrink-0 md:shrink snap-center hover:-translate-y-1 transition-all"
