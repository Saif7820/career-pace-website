    ...
    <div className="w-full bg-slate-50 py-12 md:py-20 px-6 md:px-12 font-sans">
      ...
      >
        {pillars.map((item, index) => (
          <div key={item.id} data-aos="fade-up" data-aos-delay={index * 150} className="flex flex-col bg-white rounded-[2rem] overflow-hidden shadow-xl border border-gray-100 w-[80vw] min-w-[260px] max-w-[340px] md:w-full md:min-w-0 shrink-0 md:shrink snap-center">
