  ...
  return (
    <div className="relative w-full font-sans py-10 md:py-16 px-6 flex flex-col items-center overflow-hidden" style={{ backgroundImage: `url(${bgImage2})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
      ...
      >
        ...
        {/* Phone Card */}
        <div className="bg-white rounded-3xl shadow-xl p-5 sm:p-8 md:p-10 flex flex-col items-center text-center h-56 sm:h-64 md:h-72 justify-center hover:-translate-y-1 transition-transform duration-300 w-[80vw]  max-w-[320px] md:w-full md:max-w-none md:min-w-0 shrink-0 md:shrink snap-center" data-aos="fade-up" data-aos-delay="400">
        ...
        {/* Location Card */}
        <div className="bg-white rounded-3xl shadow-xl p-5 sm:p-8 md:p-10 flex flex-col items-center text-center h-56 sm:h-64 md:h-72 justify-center hover:-translate-y-1 transition-transform duration-300 w-[80vw]  max-w-[320px] md:w-full md:max-w-none md:min-w-0 shrink-0 md:shrink snap-center" data-aos="fade-left" data-aos-delay="500">
