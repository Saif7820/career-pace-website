    ...
    <div className="relative w-full min-h-fit lg:min-h-screen py-8 lg:py-0 bg-white font-sans overflow-hidden flex flex-col justify-between">
      ...
      <div className="relative z-20 w-full px-4 pb-12 flex flex-col items-center mt-auto">
        ...
        >
          ...
          {/* Card 1 */}
          <div 
            className="flex items-center gap-3 text-white px-6 py-4 rounded-2xl shadow-xl w-[80vw]  max-w-[300px] md:w-full md:min-w-0 shrink-0 md:shrink snap-center hover:-translate-y-1 hover:shadow-2xl transition-all border border-white/20"
          ...
          {/* Card 3 */}
          <div 
            className="flex items-center gap-4 text-white px-6 py-4 rounded-2xl shadow-xl w-[80vw]  max-w-[300px] md:w-full md:min-w-0 shrink-0 md:shrink snap-center hover:-translate-y-1 hover:shadow-2xl transition-all border border-white/20"
