...
const statsCards = [
  ...
  },
  {
    ...
    content: <p className="text-xl font-bold">Pan-India Reach</p>,
    delay: 800,
  },
];
      ...
      <div className="max-w-6xl mx-auto">
        <ReusableCarousel
          ...
          renderItem={(item) => (
            <div 
              key={item.id}
              className={`flex items-center gap-4 text-white px-6 py-4 rounded-xl shadow-lg w-full ${item.bgClass}`} 
